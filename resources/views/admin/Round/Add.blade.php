                ...
                <div class="main-content">
                    <div class="container-fluid">
                        <div class="page-header">
                            <h2 class="header-title">Thêm vòng đấu</h2>
				...
				<div class="col-md-4">
					...
					@endif
                                        <div class="form-group">
                                        	<form action="admin/round/add" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label class="">Chọn giải đấu</label>
                                                ...
                                                <input placeholder="Nhập vòng đấu" name="round_number" type="text" class="form-control" >
