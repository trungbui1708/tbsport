				...
				<div class="col-md-4">
					...
					@endif
                                        <div class="form-group">
                                        	<form action="admin/round/edit/{{$round->id}}" method="POST">
                                            ...
                                            <div class="fix">
                                                ...
                                                <input placeholder="{{$round->round_number}}" value="{{$round->round_number}}" name="round_number" type="text" class="form-control" >
