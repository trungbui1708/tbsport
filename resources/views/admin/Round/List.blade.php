                                ...
                                <div class="table-overflow">
                                    <table id="dt-opt" class="table table-hover table-xl">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$key -> id}}</td>
                                                <td>{{$key -> round_number}}</td>
                                                <td>{{$key -> tournaments->name}}</td>
                                                <td class="text-center font-size-18">
                                                	<a href="admin/round/edit/{{$key->id}}" class="text-gray m-r-15"><i class="ti-pencil"></i></a>
                                                    <a href="admin/round/delete/{{$key->id}}" class="text-gray"><i class="ti-trash"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
