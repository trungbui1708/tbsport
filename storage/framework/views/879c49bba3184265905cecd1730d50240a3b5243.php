                ...
                <div class="main-content">
                    <div class="container-fluid">
                        <div class="page-header">
                            <h2 class="header-title">Sửa vòng đấu</h2>
                            <div class="header-sub-title">
                                <nav class="breadcrumb breadcrumb-dash">
                                    <a href="#" class="breadcrumb-item"><i class="ti-home p-r-5"></i>Home</a>
                                    <a class="breadcrumb-item" href="#">Vòng đấu</a>
				...
				<div class="col-md-4">
					...
					<?php endif; ?>
                                        <div class="form-group">
                                        	<form action="admin/round/edit/<?php echo e($round->id); ?>" method="POST">
                                        		<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
                                            <label class="control-label">Sửa vòng đấu</label>
                                            <div class="fix">
                                                ...
                                                <input placeholder="<?php echo e($round->round_number); ?>" value="<?php echo e($round->round_number); ?>" name="round_number" type="text" class="form-control" >
