				...
				<div class="col-md-4">
					...
					<?php endif; ?>
                                        <div class="form-group">
                                        	<form action="admin/news/edit/<?php echo e($news->id); ?>" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label class="">Chọn thể loại</label>
                                                ...
                                                <label>Mô tả</label>
                                                <input style="height: 150px;" value="<?php echo e($news->description); ?>" placeholder="Nhập mô tả" name="description" type="text" class="form-control" >
                                                <label>Nội dung</label>
                                                <textarea class="ckeditor fix-ckeditor" id="editor" value="<?php echo e($news->content); ?>"  name="content"  ></textarea>
                                                <!-- <input style="height: 120px;" placeholder="Nhập nội dung" name="content" type="text" class="form-control" > -->
