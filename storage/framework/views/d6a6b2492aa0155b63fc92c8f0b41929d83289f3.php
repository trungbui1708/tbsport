				...
				<div class="col-md-4">
					...
					<?php endif; ?>
                                        <div class="form-group">
                                        	<form action="admin/category/edit/<?php echo e($category->id); ?>" method="POST">
                                        		<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
                                            <label class="control-label">Sửa thể loại</label>
                                            <div class="fix">
                                                <input placeholder="Nhập tên thể loại" value="<?php echo e($category -> name); ?>" name="name" type="text" class="form-control" >
