					...
					<?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            <label class="">Chọn thể loại</label>
                                                ...
                                                <label>Mô tả</label>
                                                <textarea style="height: 150px;width: 700px;" value="" placeholder="Nhập mô tả" name="description" type="text" class="form-control" ><?php echo e($news->description); ?></textarea>
