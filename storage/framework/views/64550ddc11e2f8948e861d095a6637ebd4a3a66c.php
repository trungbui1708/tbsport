						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="header-top-left">                            
								<ul>
									...
									<li><img src="<?php echo e(asset('index/images/logo/vn.png')); ?>" alt="Logo">
                                        <a href="#">Việt Nam 
                                            <i class="fa fa-angle-down" aria-hidden="true"></i>
                                        </a>
										<ul>
											<li><img src="<?php echo e(asset('index/images/logo/flag1.jpg')); ?>" alt="Logo"><a href="#">English</a></li>
										</ul>
									</li>
								</ul>
							</div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-sm-12 col-xs-12 logo">
                            <a href="trangchu"><img src="<?php echo e(asset('index/images/logo.png')); ?>" alt="logo"></a>
                        </div>
		...
		<div class="slider-section4 slider-main">
          ...
          <div class="fix-slide">
					<img src="<?php echo e(asset('index/images/full-slider/ronaldo.png')); ?>" alt="Slider image">
        </div>
                    <div class="dsc">
					   <div class="container">
                            <div class="row">
				...
				<div class="item">
					 <div class="fix-slide">
                    <img src="<?php echo e(asset('upload/news/slide.jpg')); ?>" alt="Slider image">
                     </div>
                    <div class="dsc">
					   <div class="container">
                            <div class="row">
				...
				<div class="item">
					 <div class="fix-slide">
                    <img src="<?php echo e(asset('upload/news/slide2.jpg')); ?>" alt="Slider image">
                    </div>
                    <div class="dsc">
					   <div class="container">
                            <div class="row">
