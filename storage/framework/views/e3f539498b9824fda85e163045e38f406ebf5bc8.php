                ...
                <div class="main-content">
                    <div class="container-fluid">
                        <div class="page-header">
                            <h2 class="header-title">Sửa giải đấu</h2>
				...
				<div class="col-md-4">
					...
					<?php endif; ?>
                                        <div class="form-group">
                                        	<form action="admin/tournament/edit/<?php echo e($tournament->id); ?>" method="POST">
                                        		<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
                                            <label class="control-label">Sửa giải đấu</label>
                                            <div class="fix">
                                                <label>Giải đấu</label>
                                                <input placeholder="<?php echo e($tournament->name); ?>" value="<?php echo e($tournament->name); ?>" name="name" type="text" class="form-control" >
                                                <label>Mùa giải</label>
                                                <input placeholder="<?php echo e($tournament->year); ?>" value="<?php echo e($tournament->year); ?>" name="year" type="text" class="form-control" >
