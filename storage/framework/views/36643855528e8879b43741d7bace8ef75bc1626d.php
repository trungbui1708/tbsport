                ...
                <div class="side-nav-inner">
                    <ul class="side-nav-menu scrollable">
                        ...
                        <li class="nav-item dropdown">
                            <a href="admin/news/list" class="dropdown-toggle" href="javascript:void(0);">
                         ...
                         <li class="nav-item dropdown ">
                            <a href="admin/category/list" class="dropdown-toggle" href="javascript:void(0);">
                                <span class="icon-holder">
                  ...
                  <!--       <div class="fix-menu " >
                         <li class="nav-item dropdown">
                            <a class="dropdown-toggle" href="javascript:void(0);">
                                <span class="icon-holder">
                                    <i class="mdi mdi mdi-tune-vertical"></i>
                                </span>
                                <a class="text1"  href="admin/category/list">Thể loại</a>
                            </a> 
                        </li>
                    </div>
                        <div class="fix-menu " >
                         <li class="nav-item dropdown">
                            <a class="dropdown-toggle" href="javascript:void(0);">
                                ...
                                <a class="text1"  href="admin/news/list">Tin tức</a>
                            </a> 
                        </li>
                    </div> -->
                        <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle" href="javascript:void(0);">
                                ...
                                <span class="title">Lịch thi đấu</span>
                                <span class="arrow">
									<i class="mdi mdi-chevron-right"></i>
								</span>
                            </a>
