                                    ...
                                    <table id="dt-opt" class="table table-hover table-xl">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($key -> location); ?></td>
                                                <td><?php echo e($key -> establish); ?></td>
                                                <td><img width="100px" height="100px" src="upload/news/<?php echo e($key->logo); ?>"
                                                    <?php echo e($key -> logo); ?></td>
                                                <td class="text-center font-size-18">
                                                    <a href="admin/club/edit/<?php echo e($key->id); ?>" class="text-gray m-r-15"><i class="ti-pencil"></i></a>
                                                    <a href="admin/club/delete/<?php echo e($key->id); ?>" class="text-gray"><i class="ti-trash"></i></a>
                                                </td>
                                            </tr>
